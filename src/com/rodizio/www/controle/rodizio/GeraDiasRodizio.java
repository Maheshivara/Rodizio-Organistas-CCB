...
public abstract class GeraDiasRodizio {
	...
	public static List<DiaDoRodizio> modeloRodizio(Date inicio, Date fim, List<Integer> diasCulto, List<Date> listaDiasEspeciais){
		...
		if (dias<0){
			...
			for (int i=0; i<dias;i++){
				int qtdePartes=0;
				/**
				 * Verifica se o Dia da Semana � Domingo, para gerar as Partes da Reuni�o de Jovens e Menores.
				 */
