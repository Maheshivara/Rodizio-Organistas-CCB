	...
	public boolean inserir(List<ModTelPessoa> tel){
		...
		for(ModTelPessoa listaTel : tel){
			...
			if(!DAOTelPessoa.insert(listaTel, conn)){
				System.out.println("N�o Consegui Inserir o Email: "+listaTel.getTelefone_pessoa());
				return false;
			}
		}
		fechaConexao();		
	...
	public boolean update(List<ModTelPessoa> tel){
		...
		for(ModTelPessoa listaTel : tel){
			...
			if(!DAOTelPessoa.update(listaTel, conn)){
				update(listaTel);
				System.out.println("N�o Consegui Alterar o Email: "+listaTel.getTelefone_pessoa());
				return false;
			}
		}
