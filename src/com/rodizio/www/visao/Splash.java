...
/**
 * Tela de Inicializa��o do Sistema.
 * Implementada utilizando Explica��es do Site Youtube demonstando como Criar uma SPLASH Screem
...
public class Splash {
	...
	private void initialize() {
		frame = new JFrame();
		frame.setIconImage(Toolkit.getDefaultToolkit().getImage(Splash.class.getResource("/com/rodizio/www/visao/imagens/claveDeSol35x35.jpg")));
		...
		panel.add(label);
		label.setIcon(new ImageIcon(Splash.class.getResource("/com/rodizio/www/visao/imagens/clave-sol.jpg")));
