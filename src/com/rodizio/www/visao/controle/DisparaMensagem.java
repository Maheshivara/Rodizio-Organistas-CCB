...
public abstract class DisparaMensagem {
	...
	public static void msg(int opcao, Component frame){
		...
		case 2:
			/**
			 * "O Campo Senha devera ser preenchido com no m�nimo 3 caracteres.\nDigite novamente."
			 */
			Mensagens.setMensagens(frame,"O Campo Senha devera ser preenchido com no m�nimo 3 caracteres.\nDigite novamente.");
			break;
		case 3:
			/**
		...
		case 4:
			/**
			 * "Numero M�ximo de Tentativas Esgotados. \nAbra o Sistema Novamente." 
			 */
			Mensagens.setMensagens(frame,"Numero M�ximo de Tentativas Esgotados. \nAbra o Sistema Novamente.");
			break;
		case 5:
			/**
			 *"Sem Acesso ao Banco de Dados. \nPor favor Verifique o Servidor de Banco de Dados. \nE Abra o Sistema Novamente."
			 */
			Mensagens.setMensagens(frame,"Sem Acesso ao Banco de Dados. \nPor favor Verifique o Servidor de Banco de Dados. \nE Abra o Sistema Novamente.");
			break;
		case 6:
			/**
		...
		case 9:
			 ...
			 */
			Mensagens.setMensagens(frame,"Nao Foi possivel Gravar os Dados no Banco de Dados.\nVerifique e Tente novamente.");
			break;
		case 10:
			/**
		...
		case 11:
			/**
			 *"Existe Campo com Tamanho Invalido, por favor preencha com o Tamanho correto." *** 
			 */
