...
class CadastroMinisterio extends JInternalFrame {
	...
	setTitle("Cadastro de Minist�rio");
	...
	btnBuscar_1.addActionListener(new ActionListener() {
		...
		try {
			...
			JOptionPane.showMessageDialog(rootPane, "N�o Encontrei um Cadastro Correspondente.\nMude o nome e Pesquise novamente.");
	...
	JLabel lblDigiteONome = new JLabel("Digite o Nome ou Parte dele, Ou Deixe em branco para buscar Todas Pessoas Cadastradas.");
	...
	// Pega a String e tira letras(pega o elemento do Modelo do Combo (que est� na posi�ao index do Combo)).
	...
	if (!ok) {
	    telefone.setBorder(new BevelBorder(BevelBorder.LOWERED, new Color(255, 0, 0), Color.RED, new Color(255, 0, 0), Color.RED));
	    telefone.grabFocus();
	} else {
	    telefone.setBorder(new BevelBorder(BevelBorder.LOWERED, UIManager.getColor("nimbusFocus"), UIManager.getColor("nimbusFocus"), UIManager.getColor("nimbusFocus"), UIManager.getColor("nimbusFocus")));
