...
public class CadastroOrganistas extends CadastroMinisterio {
	...
	//Como estes Checkboxes n�o s�o exibidos, todos estar�o selecionados por default.
	...
	if(!ok){
	    JOptionPane.showMessageDialog(chkDomingo, "Ao menos um dia de Culto dever� estar Selecionado.");
	    return false;
	}
	return true;
    }
